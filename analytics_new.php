<?php
/**
 * analytics_new.php - Analytics Dashboard
 * 
 ...
 * 
 * Path: /data/www/default/nba-wins-platform/public/analytics_new.php
 */
                            ...
                            <tbody>
                                <?php foreach ($overperformers as $i => $team): ?>
                                    <tr>
                                        ...
                                        <td class="participant-name">
                                            <a href="/nba-wins-platform/profiles/participant_profile_new.php?league_id=<?= $league_id ?>&user_id=<?= $team['user_id'] ?>">
                ...
                <table class="leaderboard-table" id="sos-table">
                    ...
                    <tbody>
                        <?php foreach ($strengthOfSchedule as $entry): ?>
                            <tr>
                                <td class="participant-name">
                                    <a href="/nba-wins-platform/profiles/participant_profile_new.php?league_id=<?= $league_id ?>&user_id=<?= $entry['user_id'] ?>">
                            ...
                            <tbody>
                                <?php foreach ($bestDraftSteals as $steal): ?>
                                    <tr>
                                        ...
                                        <td class="participant-name">
                                            <a href="/nba-wins-platform/stats/team_data_new.php?team=<?= urlencode($steal['team_name']) ?>"
                                               style="display: flex; align-items: center; gap: 8px">
                                        ...
                                        <td class="participant-name hide-mobile">
                                            <a href="/nba-wins-platform/profiles/participant_profile_new.php?league_id=<?= $steal['league_id'] ?>&user_id=<?= $steal['user_id'] ?>">
                            ...
                            <tbody>
                                <?php foreach ($worstDraftPicks as $bust): ?>
                                    <tr>
                                        ...
                                        <td class="participant-name">
                                            <a href="/nba-wins-platform/stats/team_data_new.php?team=<?= urlencode($bust['team_name']) ?>"
                                               style="display: flex; align-items: center; gap: 8px">
                                        ...
                                        <td class="participant-name hide-mobile">
                                            <a href="/nba-wins-platform/profiles/participant_profile_new.php?league_id=<?= $bust['league_id'] ?>&user_id=<?= $bust['user_id'] ?>">
...
<?php endif; ?>
    ...
    <nav class="floating-pill">
        ...
        <a href="/analytics_new.php" class="pill-item active" data-label="Analytics"><i class="fas fa-chart-line"></i></a>
