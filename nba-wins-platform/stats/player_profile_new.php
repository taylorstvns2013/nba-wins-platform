<?php
/**
 * player_profile_new.php - Individual Player Profile
 * 
 ...
 * 
 * Path: /data/www/default/nba-wins-platform/stats/player_profile_new.php
 */
...
$rosterUrl = '/nba-wins-platform/stats/team_data_new.php?team=' . urlencode($team_name) . '&tab=roster';
    ...
    <?php if ($hasEspnStats): ?>
        <div class="stats-card">
            <h2 class="section-title">
                <i class="fas fa-chart-bar"></i> 2025-26 Season Stats
            ...
            <!-- Shooting splits -->
            <h3 class="detail-section-title"><i class="fas fa-bullseye"></i> Shooting</h3>
            ...
            <!-- Additional stats -->
            <h3 class="detail-section-title"><i class="fas fa-chart-line"></i> Additional</h3>
            <div class="detail-stats-grid">
                <div class="detail-stat">
