 ...
 * 
 * Path: /data/www/default/nba-wins-platform/stats/team_data.php
 */
        ...
        <div class="section">
            ...
            <?php if (!empty($lastGames)): ?>
                <?php foreach ($lastGames as $gd_game):
                    ...
                    $gameUrl   = "/nba-wins-platform/stats/game_details.php"
        ...
        <div class="section">
            ...
            <?php if (!empty($upcomingGames)): ?>
                <?php foreach ($upcomingGames as $gd_game):
                    $compUrl = "/nba-wins-platform/stats/team_comparison.php"
                             . "?home_team=" . urlencode($gd_game['home_team_code'])
                             . "&away_team=" . urlencode($gd_game['away_team_code'])
                             . "&date=" . urlencode($gd_game['game_date']);
                ?>
        ...
        <div class="section" style="padding: 0.75rem; background: transparent; box-shadow: none;">
            ...
            <?php if (!empty($fullSchedule)): ?>
                <?php foreach ($fullSchedule as $gd_game):
                    ...
                    $gameUrl = $isCompleted
                        ? "/nba-wins-platform/stats/game_details.php"
                          . "?home_team=" . urlencode($gd_game['home_team_code'])
                          . "&away_team=" . urlencode($gd_game['away_team_code'])
                          . "&date=" . urlencode($gd_game['game_date'])
                        : "/nba-wins-platform/stats/team_comparison.php"
                          . "?home_team=" . urlencode($gd_game['home_team_code'])
                          . "&away_team=" . urlencode($gd_game['away_team_code'])
                          . "&date=" . urlencode($gd_game['game_date']);
                ?>
