...
<head>
    ...
    <title>Game Details - NBA Wins Pool League</title>
...
<body>
    ...
    ?>
    <div class="container">
        <a href="javascript:history.back()" class="back-button">← Back to Games</a>
        ...
        <div class="venue-info">
            <h3 class="text-xl font-bold mb-2"><?php echo htmlspecialchars($game['arena']); ?></h3>
            <p class="text-gray-600">
                <?php 
                // Format the date
                echo date('F j, Y', strtotime($game['date']));
                
                // If there's a game start time
                if (isset($game['start_time'])) {
                    // Convert to desired time format without timezone
                    echo ' • ' . date('g:i A', strtotime($game['start_time']));
                }
                ?>
            </p>
        </div>
        ...
        <section class="section">
            <h3 class="text-xl font-bold mb-2">Box Score</h3>
            <table>
                <thead>
                    <tr>
                        <th>Team</th>
        ...
        <!-- Player Stats -->
        <section class="section">
            <h3 class="text-xl font-bold mb-2">Player Statistics</h3>
            <?php 
            ...
            ?>
                <h4 class="text-lg font-bold mt-4"><?php echo htmlspecialchars(normalizeTeamName($team)); ?></h4>
        ...
        <section class="section">
            ...
            ?>
                <h4 class="text-lg font-bold mt-2"><?php echo htmlspecialchars($team); ?></h4>
