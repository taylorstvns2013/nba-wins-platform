...
// For use with index.php dark theme redesign
...
<div class="dark-nav-container">
    ...
    <div class="dark-nav-panel" id="darkNavPanel">
        ...
        <nav class="dark-nav-links">
            <a href="/index.php" class="dark-nav-link">
                <i class="fas fa-home"></i> Home
            </a>
            <a href="/nba-wins-platform/profiles/participant_profile.php?league_id=<?php echo $currentLeagueId; ?>&user_id=<?php echo $profileUserId; ?>" class="dark-nav-link">
                <i class="fas <?php echo $isGuest ? 'fa-users' : 'fa-user'; ?>"></i> <?php echo $isGuest ? 'Profiles' : 'My Profile'; ?>
            </a>
            <a href="/analytics.php" class="dark-nav-link">
                <i class="fas fa-chart-line"></i> Analytics
            </a>
            <a href="/claudes-column.php" class="dark-nav-link">
                <i class="fa-solid fa-newspaper"></i> Claude's Column
                <?php if ($hasNewArticles): ?>
                    <span class="dark-nav-new-badge">NEW</span>
                <?php endif; ?>
            </a>
            <a href="/nba_standings.php" class="dark-nav-link">
                <i class="fas fa-basketball-ball"></i> NBA Standings
            </a>
            <a href="/draft_summary.php" class="dark-nav-link">
