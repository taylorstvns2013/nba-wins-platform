<?php
// /data/www/default/nba-wins-platform/core/DashboardWidget_new.php
// Renders individual widgets on the homepage dashboard - DARK THEME VERSION
// Matches the dark UI of index_new.php
            ...
            <div class="dw-body">
                ...
                <div class="dw-lb-teams" id="<?php echo $teamListId; ?>">
                    ...
                    <div class="dw-lb-team-row">
                        <a href="/nba-wins-platform/stats/team_data_new.php?team=<?php echo urlencode($team['team_name']); ?>" 
                ...
                <table class="dw-steals-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/nba-wins-platform/stats/team_data_new.php?team=<?php echo urlencode($steal['team_name']); ?>" class="dw-steals-team-link">
                            ...
                            <td class="dw-steals-hide-mobile">
                                <a href="/nba-wins-platform/profiles/participant_profile_new.php?league_id=<?php echo $steal['league_id']; ?>&user_id=<?php echo $steal['user_id']; ?>" 
            ...
            <div class="dw-body">
                ...
                <div class="dw-team-stat-row">
                    <div class="dw-team-stat-left">
                        ...
                        <div>
                            <a href="/nba-wins-platform/stats/team_data_new.php?team=<?php echo urlencode($team['team_name']); ?>" class="dw-team-stat-name">
        ...
        <div class="dw-card" data-widget-type="upcoming_games">
            ...
            <div class="dw-body dw-game-list">
                <?php foreach ($upcomingGames as $game): 
                    $comparisonUrl = "/nba-wins-platform/stats/team_comparison_new.php?home_team=" . urlencode($game['home_team_code']) . "&away_team=" . urlencode($game['away_team_code']) . "&date=" . urlencode($game['game_date']);
                ?>
        ...
        <div class="dw-card" data-widget-type="last_10_games">
            ...
            <div class="dw-body dw-game-list">
                <?php foreach (array_reverse($lastGames) as $game): 
                    ...
                    $gameUrl = "/nba-wins-platform/stats/game_details_new.php?home_team=" . urlencode($game['home_team_code']) . "&away_team=" . urlencode($game['away_team_code']) . "&date=" . urlencode($game['game_date']);
                    $isWin = $game['result'] === 'W';
                ?>
                ...
                <table class="dw-sos-table">
                    ...
                    <tbody id="sos-table-body">
                        ...
                        <tr data-games="<?php echo $entry['total_games']; ?>" 
                            ...
                            <td>
                                <a href="/nba-wins-platform/profiles/participant_profile_new.php?league_id=<?php echo $league_id; ?>&user_id=<?php echo $entry['user_id']; ?>" 
        ...
        <div class="dw-card" data-widget-type="<?php echo $widget_type; ?>">
            ...
            <div style="text-align: center; padding: 40px 20px;">
                ...
                <p style="color: var(--text-secondary); margin: 8px 0;">
                    View this content on the <a href="analytics_new.php" style="color: var(--accent-blue); text-decoration: none; font-weight: 600;">Analytics page</a>
                </p>
            </div>
        </div>
        <?php
