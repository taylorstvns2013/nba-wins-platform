<?php
// claudes-column.php - Sports Column Page (Dark Theme)
session_start();
...
<body>
        ...
        <div class="guest-lock-overlay">
            <div class="guest-lock-box">
                ...
                <div class="guest-lock-actions">
                    ...
                    <a href="/index.php" class="guest-lock-btn guest-lock-btn-secondary">Go Back</a>
                </div>
            </div>
        </div>
    <?php endif; ?>
    ...
    <nav class="floating-pill" id="floatingPill">
        ...
        <div class="pill-main-row">
            ...
            <a href="/claudes-column.php" class="pill-item active" data-label="Column" style="position:relative">
